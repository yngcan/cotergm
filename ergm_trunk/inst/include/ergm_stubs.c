...
#include "R_ext/Rdynload.h"
#include "edgetree.h"
Network NetworkInitialize(Vertex *tails, Vertex *heads, Edge nedges,Vertex nnodes, int directed_flag, Vertex bipartite,int lasttoggle_flag, int time, int *lasttoggle, double *nodalstatus){
...
Network NetworkInitializeD(double *tails, double *heads, Edge nedges,Vertex nnodes, int directed_flag, Vertex bipartite,int lasttoggle_flag, int time, int *lasttoggle, double *nodalstatus){
...
if(fun==NULL) fun = (void (*)(int *, int *,
		  ...
		  int *, int *, int *,
		  int *,
		  int *)) R_FindSymbol("MCMC_wrapper", "ergm", NULL);
fun( dnumnets,  dnedges,
		   tails,  heads,
		   dn,
			 y0tails,  y0heads, y0dn, y0nedges, y0nodalstatus, dflag,  bipartite,
		   nterms,  funnames,
		   sonames,
		   MHproposaltype,  MHproposalpackage,
		   inputs,   nodalstatus,  theta0,  samplesize,
...
MCMCStatus MCMCSample(MHproposal *MHp,double *theta, double *networkstatistics,int samplesize, int burnin,int interval, int fVerbose, int nmax,Network *nwp, Model *m,Network *y0){
static MCMCStatus (*fun)(MHproposal *,double *,double *,int,int,int,int,int,Network *,Model *,Network *) = NULL;
if(fun==NULL) fun = (MCMCStatus (*)(MHproposal *,double *,double *,int,int,int,int,int,Network *,Model *,Network *)) R_FindSymbol("MCMCSample", "ergm", NULL);
return fun(MHp,theta,networkstatistics,samplesize,burnin,interval,fVerbose,nmax,nwp,m,y0);
}
MCMCStatus MetropolisHastings(MHproposal *MHp,double *theta, double *statistics,int nsteps, int *staken,int fVerbose,Network *nwp, Model *m,Network *y0){
static MCMCStatus (*fun)(MHproposal *,double *,double *,int,int *,int,Network *,Model *,Network *) = NULL;
if(fun==NULL) fun = (MCMCStatus (*)(MHproposal *,double *,double *,int,int *,int,Network *,Model *,Network *)) R_FindSymbol("MetropolisHastings", "ergm", NULL);
return fun(MHp,theta,statistics,nsteps,staken,fVerbose,nwp,m,y0);
}
...
void MCMCSamplePhase12(MHproposal *MH,double *theta, double gain, double *meanstats,int nphase1, int nsubphases, double *networkstatistics,int samplesize, int burnin,int interval, int fVerbose,Network *nwp, Model *m,Network *y0){
static void (*fun)(MHproposal *,double *,double,double *,int,int,double *,int,int,int,int,Network *,Model *,Network *) = NULL;
if(fun==NULL) fun = (void (*)(MHproposal *,double *,double,double *,int,int,double *,int,int,int,int,Network *,Model *,Network *)) R_FindSymbol("MCMCSamplePhase12", "ergm", NULL);
fun(MH,theta,gain,meanstats,nphase1,nsubphases,networkstatistics,samplesize,burnin,interval,fVerbose,nwp,m,y0);
}
#undef MIN
#undef MAX
#undef DYADCOUNT
...
Model* ModelInitialize(char *fnames, char *sonames, double **inputs,
		int n_terms, int n_nodes, double *nodalstatus){
static Model* (*fun)(char *,char *,double **,int,int,double *) = NULL;
if(fun==NULL) fun = (Model* (*)(char *,char *,double **,int, int, double *)) R_FindSymbol("ModelInitialize", "ergm", NULL);
return fun(fnames,sonames,inputs,n_terms,n_nodes,nodalstatus);
}
...
void ChangeStats(unsigned int ntoggles, Vertex *toggletail, Vertex *togglehead,Vertex *togglenode, Network *nwp, Model *m,Network *y0){
static void (*fun)(unsigned int,Vertex *,Vertex *,Vertex *, Network *,Model *,Network *) = NULL;
if(fun==NULL) fun = (void (*)(unsigned int,Vertex *,Vertex *,Vertex *,Network *,Model *,Network *)) R_FindSymbol("ChangeStats", "ergm", NULL);
fun(ntoggles,toggletail,togglehead,togglenode, nwp,m,y0);
}
#undef MIN
#undef MAX
#undef DYADCOUNT
